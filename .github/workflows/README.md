...
jobs:
  all-green:
    uses: clean-botix/github-actions/.github/workflows/all-green.yml@v3.1.0
```
...
jobs:
  build:
    uses: clean-botix/github-actions/.github/workflows/build.yml@v3.1.0
    secrets:
...
jobs:
  lint:
    uses: clean-botix/github-actions/.github/workflows/golangci-lint.yml@v3.1.0
```
...
jobs:
  sync:
    uses: clean-botix/github-actions/.github/workflows/pr-create.yml@v3.1.0
    secrets:
...
jobs:
  release:
    uses: clean-botix/github-actions/.github/workflows/release.yml@v3.1.0
    secrets:
...
jobs:
  notify:
    uses: clean-botix/github-actions/.github/workflows/notify-slack.yml@v3.1.0
    secrets:
...
jobs:
  robot-test-check:
    uses: clean-botix/github-actions/.github/workflows/test-robot-check.yml@v3.1.0
    secrets:
...
jobs:
  robot-test-label:
    uses: clean-botix/github-actions/.github/workflows/test-robot-label.yml@v3.1.0
    secrets:
      token: ${{ secrets.GITHUB_TOKEN }}
```
...
jobs:
  robot-test-remove:
    uses: clean-botix/github-actions/.github/workflows/test-robot-remove.yml@v3.1.0
    secrets:
      token: ${{ secrets.GITHUB_TOKEN }}
```
