...
jobs:
  all-green:
    uses: clean-botix/github-actions/.github/workflows/all-green.yml@v4.0.0
```
...
jobs:
  build:
    uses: clean-botix/github-actions/.github/workflows/build.yml@v4.0.0
    secrets:
...
jobs:
  lint:
    uses: clean-botix/github-actions/.github/workflows/golangci-lint.yml@v4.0.0
```
...
jobs:
  sync:
    uses: clean-botix/github-actions/.github/workflows/pr-create.yml@v4.0.0
    secrets:
...
jobs:
  release:
    uses: clean-botix/github-actions/.github/workflows/release.yml@v4.0.0
    secrets:
...
jobs:
  notify:
    uses: clean-botix/github-actions/.github/workflows/notify-slack.yml@v4.0.0
    secrets:
...
jobs:
  robot-test-check:
    uses: clean-botix/github-actions/.github/workflows/test-robot-check.yml@v4.0.0
    secrets:
...
jobs:
  robot-test-label:
    uses: clean-botix/github-actions/.github/workflows/test-robot-label.yml@v4.0.0
    secrets:
      token: ${{ secrets.GITHUB_TOKEN }}
```
...
jobs:
  robot-test-remove:
    uses: clean-botix/github-actions/.github/workflows/test-robot-remove.yml@v4.0.0
    secrets:
      token: ${{ secrets.GITHUB_TOKEN }}
```
